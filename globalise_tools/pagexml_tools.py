...
def children_elements(node: Optional[ET.Element]) -> List[ET.Element]:
    if node is None:
        return []
...
def convert_pagexml_to_web_annotations(xml_string: str, canvas_id: str,
    ...
    creator = cf.creator(label="Creation of Web Annotations from PageXML HTR output (generated by the GLOBALISE Loghi HTR model).")
